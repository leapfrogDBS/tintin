...
if( !class_exists( 'vx_crmperks_notice_vxcf_mailchimp' )):

class vx_crmperks_notice_vxcf_mailchimp extends vxcf_mailchimp{
    
public $plugin_url="https://www.crmperks.com";
public $review_link='https://wordpress.org/support/plugin/cf7-mailchimp/reviews/?filter=5#new-post';
...
$msg =sprintf(__('Want to save contact form 7 submissions? Manage contact form 7 entries , View Mailchimp status of any entry and Send any entry to Mailchimp with free %sConatct Form Entries Plugin%s','crm-perks-forms'),'<a href="https://wordpress.org/plugins/contact-form-entries/" target="_blank">','</a>');
?>
...
<p><i class="fa fa-check"></i> View mailchimp status(sent or not sent) of any entry.</p>
<p><i class="fa fa-check"></i> Easily Resend any entry to mailchimp.</p>
...
//$install_time['review_closed']='';
    $time=current_time( 'timestamp' , 1 )-(3600*28);
...
<p><b><a href="https://wordpress.org/plugins/support-x/" target="_blank">Support X - Wordpress Helpdesk</a></b> Shows user tickets from HelpScout, mailchimp, FreshDesk, Desk.com and Teamwork in wordpress. Users can create new tickets and reply to old tickets from wordpress.</p>
</div>
<?php    
}
...
new vx_crmperks_notice_vxcf_mailchimp();
endif;
