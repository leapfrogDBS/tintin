...
class WPZ_Generate_Random_Orders_For_WooCommerce_Notices {
	...
	public static function notice_admin_review_conditions() {
		return get_option( 'wpz_woocommerce_random_orders_notice_hidden' ) && get_option( 'wpz_woocommerce_random_orders_notice_hidden' ) != 1 && time() - get_option( 'wpz_woocommerce_random_orders_first_activate' ) >= ( self::NOTICE_DAYS * 86400 );
	}
